...
- **Status:** Accepted for E2.1; review before multi-file replacement or indexing
- **Date:** 2026-09-09
...
Case-insensitive and regular-expression workspace search, include/exclude globs, ignored-file search, persistent indexing, multi-root result grouping controls, preview context expansion, symbol search, multi-file replacement, replacement recovery, and search-result persistence remain later slices.
