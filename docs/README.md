...
- [`benchmarks/2026-09-12-remote-toolbar-markdown-memory.md`](benchmarks/2026-09-12-remote-toolbar-markdown-memory.md) — flat remote-action semantics, Update/Push confirmation, future conflict destination, Markdown-mode persistence, and local package evidence.
