...
U1 is locally accepted: Asterlyn now uses one compact draggable application bar with accessible window controls instead of stacking it below the native title row. U2 per-commit file and patch inspection is the next active product slice.
