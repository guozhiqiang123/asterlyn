...
pub use model::{
    ...
    CommitComparisonDiffResult, CommitDetails, CommitDiffResult, CommitFileChange, CommitSummary,
    DiffResult, FileChange, GitBlameHunk, GitBlameResult, GitConflictContent, GitConflictFile,
    GitOperationAction, GitOperationKind, GitOperationPhase, GitOperationPlan,
