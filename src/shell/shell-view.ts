    ...
    <header class="topbar" data-tauri-drag-region>
      ...
      <div class="topbar-actions" data-tauri-drag-region>
        ...
        <div class="remote-toolbar git-unavailable" id="remote-toolbar" role="group" aria-label="${escapeHtml(copy.remoteActions)}">
          ...
          <span class="topbar-remote-action" id="remote-update-hint"><button class="icon-button remote-action-button" id="remote-update" type="button" data-remote-action="pull" aria-label="${escapeHtml(copy.updateBranch)}" title="${escapeHtml(copy.updateBranch)}" aria-disabled="true">${icon("sync", 18)}</button></span>
