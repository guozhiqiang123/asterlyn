...
export interface ChangesCopy {
  contextMenu: {
    ...
    unversionedGroupAriaLabel(count: number): string;
    stageAllUnversioned: string;
    trashAllUnversioned: string;
  };
  ...
  stagingUnversioned(count: number): string;
  stagedUnversioned(count: number): string;
  saveBeforeTrashUnversioned: string;
  confirmTrashUnversionedTitle: string;
  confirmTrashUnversioned: string;
  trashUnversionedDescription(count: number): string;
  trashUnversionedWarning(count: number): string;
  trashingUnversioned(completed: number, total: number): string;
  trashedUnversioned(count: number): string;
...
export interface RemoteCopy {
  ...
  resizePushDialog: string; resizePushPreview: string; newBadge: string;
  newBranchOption: string; newBranchPlaceholder: string;
  chooseExistingBranch: string; invalidBranchName: string;
