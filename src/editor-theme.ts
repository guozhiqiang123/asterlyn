...
const editorThemeRules =
  {
    ...
    ".asterlyn-search-input-shell": { alignItems: "flex-start" },
    ...
    ".asterlyn-search-input-shell textarea": {
      boxSizing: "border-box",
      width: "100%",
      minWidth: "70px",
      minHeight: "31px",
    ...
    ".asterlyn-search-panel .asterlyn-search-option-strip button": {
      ...
      fontSize: "max(10px, calc(var(--ui-font-size, 13px) - 2px))",
    },
    ...
    ".asterlyn-search-panel .asterlyn-search-option-strip button:hover": { borderColor: "var(--border)" },
    ".asterlyn-search-panel .asterlyn-search-option-strip button[aria-pressed=true]": {
